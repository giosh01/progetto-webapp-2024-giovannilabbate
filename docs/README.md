...
- `/` → redirect alla home (`/home/index.html`)
- `/home/index.html` → pagina iniziale
- `/dashboard/mesocicli/index.html` → lista mesocicli con modale creazione e modifica
- `/dashboard/microcicli/index.html` → lista microcicli con modale e grafico
- `/dashboard/dettaglio/index.html` → hub con accesso a scheda e logbook
- `/dashboard/scheda_allenamento/index.html` → scheda (split, parametri, sedute previste)
- `/dashboard/logbook/index.html` → logbook con parametri giornalieri, note e sedute eseguite
